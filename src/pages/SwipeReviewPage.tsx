    ...
    <div className="space-y-8 max-w-xl mx-auto text-center relative min-h-[70vh] flex flex-col justify-between">
      ...
      <div>
        <div className="flex justify-between items-center mb-6">
          <Link
            ...
            className="text-xs font-bold text-slate-400 hover:text-slate-200 flex items-center gap-1.5"
          >
        ...
        {campaign && (
          <div className="mb-8">
            <h2 className="text-2xl font-extrabold text-slate-100">{campaign.title}</h2>
            <p className="text-slate-400 text-xs mt-1">Review pending candidates using controls or arrow keys.</p>
          </div>
        )}
      </div>
      ...
      <div className="flex-1 flex items-center justify-center min-h-[350px]">
        {currentApp && currentCreator ? (
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-10 text-center w-full py-16">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.2} stroke="currentColor" className="w-12 h-12 text-slate-600 mx-auto mb-4">
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 0 1-1.043 3.296 3.745 3.745 0 0 1-3.296 1.043A3.745 3.745 0 0 1 12 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 0 1-3.296-1.043 3.745 3.745 0 0 1-1.043-3.296A3.745 3.745 0 0 1 3 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 0 1 1.043-3.296 3.746 3.746 0 0 1 3.296-1.043A3.746 3.746 0 0 1 12 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 0 1 3.296 1.043 3.746 3.746 0 0 1 1.043 3.296A3.745 3.745 0 0 1 21 12Z" />
            </svg>
            <h4 className="font-bold text-slate-200 mb-1">Queue Completed</h4>
            <p className="text-slate-400 text-xs max-w-xs mx-auto">No more pending applications for this campaign.</p>
          </div>
        )}
      </div>
        ...
        <div className="mt-8">
          {queue.length > 1 && (
            <button
              ...
              className="mb-4 px-4 py-2 rounded-xl bg-purple-500/10 hover:bg-purple-500/20 border border-purple-500/20 text-xs font-bold text-purple-300 transition-colors"
            >
